...
/**
 * Simple drawCube method created to allow for the persons limbs to quickly call the cube
 * Code directly taken from Example.AnimatedPerson Class
 * Formatting & Comments done by Danica
 * This code was just directly imported since it was quick and easy to use 
 * and simple
 */
